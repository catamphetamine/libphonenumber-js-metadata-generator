...
Metadata generated by `libphonenumber-metadata-generator` has a numeric `version`. This is for backwards compatibility, because metadata file format could change in some future. Hence, a different `version` value should be treated as a "breaking change".
